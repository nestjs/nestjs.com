      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 font-light overflow-hidden transition-colors duration-300 ease-in-out hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
              enableBorderGlow ? "card--border-glow" : ""
            }`;

            const borderRadius = "36px";
            const cardStyle = {
              ...
              borderTopRightRadius: index === 2 ? borderRadius : 0,
              borderBottomLeftRadius: index === 3 ? borderRadius : 0,
              borderBottomRightRadius: index === 5 ? borderRadius : 0,
              borderTopWidth: "1px",
              borderBottomWidth: index < 3 ? "0" : "1px",
              borderLeftWidth: "1px",
              borderRightWidth: index === 2 || index === 5 ? "1px" : "0",
