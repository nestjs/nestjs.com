...
function SponsorCell({
  ...
  return (
    <BlurIn duration={0.5} ease="power2.out">
      <div
        className={`cell w-[160px] h-[160px] border border-[#1e1d1d] flex items-center ${className}`}
      >
        {children}
      </div>
    </BlurIn>
...
export function SponsorsSection() {
  ...
  return (
    <div className="mt-50 mb-50">
      ...
      <div className="container relative flex mt-40 mx-auto flex-col">
        <div className="flex flex-cols items-center justify-between w-full">
            ...
            <SponsorCell>
              <a href="https://www.trilon.io" className={CELL_COMMON_CLASSES}>
                <img
                  ...
                  alt="Trilon"
                  className="w-full h-full object-contain p-4 brightness-100"
                />
              </a>
            </SponsorCell>
            <SponsorCell className="ml-[-1px]">
              <a href="https://www.mojam.com" className={CELL_COMMON_CLASSES}>
                <img
                  ...
                  alt="Mojam"
                  className="w-full h-full object-contain p-7 brightness-100 max-h-[100px]"
                />
              </a>
            </SponsorCell>
            <SponsorCell className="ml-[-2px]">
              ...
              >
                <img
                  ...
                  alt="Microsoft"
                  className="w-full h-full object-contain p-7 brightness-100"
                />
              </a>
            </SponsorCell>
        ...
        <div className="flex flex-cols items-center justify-between w-full mt-20">
          <div className="self-start">
          ...
          <div className="grid grid-cols-6 gap-0">
            {silverSponsors.map((sponsor) => (
              <BlurIn key={sponsor.MemberId} duration={0.5} ease="power2.out">
                <div className="cell w-[160px] h-[160px] border border-white/10 flex items-center">
                  <a
        ...
        <div className="flex flex-cols items-center justify-between w-full mt-20">
          ...
          <div className="grid grid-cols-12 gap-0">
            {bronzeSponsors.map((sponsor) => (
              <BlurIn key={sponsor.MemberId} duration={0.5} ease="power2.out">
                <div className="cell w-[80px] h-[80px] border border-white/10 flex items-center">
                  <a
                    href={sponsor.website || "#"}
